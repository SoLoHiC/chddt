// Filename: WaveFileWriter.ava
// Reference: http://www.cnblogs.com/liyiwen/archive/2010/04/19/1715715.html
// Creator: RobinTang
// Time: 2012-09-02
package com.sin.java.media;
...
public class WaveFileWriter {
	...
	public void initWriter(String filename, int[][] data, int offset, int len, long samplerate) {
		...
		try {
			...
			writeString(this.chunkdescriptor, this.lenchunkdescriptor);
			writeLong(this.chunksize);
			writeString(this.waveflag, this.lenwaveflag);
			writeString(this.fmtsubchunk, this.lenfmtsubchunk);
			...
			writeString(this.datasubchunk, this.lendatasubchunk);
