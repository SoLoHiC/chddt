package cn.ynu.android.chddt.ui;
...
public class OpenFileDialog {
	...
	public static Dialog createDialog(int id, Context context, String title, CallbackBundle callback, String suffix, Map<String, Integer> images, String spath){
		AlertDialog.Builder builder = new AlertDialog.Builder(context);
		builder.setView(new FileSelectView(context, id, callback, suffix, images, spath));
	...
	static class FileSelectView extends ListView implements OnItemClickListener{
		...
		public FileSelectView(Context context, int dialogid, CallbackBundle callback, String suffix, Map<String, Integer> images, String spath) {
			super(context);
